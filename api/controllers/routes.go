...
func (s *Server) initializeRoutes() {
	...
	// s.Router.HandleFunc("/register", middlewares.SetMiddlewareJSON(s.Logout)).Methods("POST")
 
	//Users routes
	s.Router.HandleFunc("/register", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthentication(s.CreateUser))).Methods("POST")
